...
PKG             := clementine_qt4
$(PKG)_IGNORE   :=
$(PKG)_VERSION  := 95187ed
$(PKG)_CHECKSUM := e65624b70dc803aaa98a4827586f5e22a06cf533f861992a36987f60784490ec
...
$(PKG)_DEPS     := boost cc chromaprint cryptopp fftw glew \
                   ...
                   liblastfm_qt4 libmpcdec protobuf qtsparkle_qt4 qjson-qt4 sparsehash
