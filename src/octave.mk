...
$(PKG)_DEPS     := arpack blas curl fftw fltk freetype gcc glpk gnuplot graphicsmagick hdf5 lapack libgomp pcre pthreads qrupdate readline suitesparse texinfo zlib
## fontconfig pstoedit qhull qscintilla qt ### FIXME: these are dependencies for Octave, but do not build yet
