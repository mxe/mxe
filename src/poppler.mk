...
$(PKG)_IGNORE   :=
$(PKG)_VERSION  := 21.07.0
$(PKG)_CHECKSUM := e26ab29f68065de4d6562f0a3e2b5435a83ca92be573b99a1c81998fa286a4d4
...
define $(PKG)_BUILD
    ...
    '$(TARGET)-g++' \
        ...
        `'$(TARGET)-pkg-config' poppler-cpp libopenjp2 --cflags --libs` -liconv
endef
