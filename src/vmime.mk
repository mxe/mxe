...
PKG             := vmime
$(PKG)_IGNORE   :=
$(PKG)_VERSION  := b1c2d4b
$(PKG)_CHECKSUM := db41773878fcd11de44999cb5eba6e4f43e7135bc64c1fd82ad2ef2cb0d24cf1
...
define $(PKG)_BUILD
    ...
    $(if $(BUILD_SHARED),$(INSTALL) -m644 '$(BUILD_DIR)/build/bin/libvmime.dll' '$(PREFIX)/$(TARGET)/bin/')
